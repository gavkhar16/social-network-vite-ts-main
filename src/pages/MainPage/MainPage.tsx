...
export const MainPage = () => {
  const navbarItems = [
    ...
    },
    {
      ...
      },
      {
        ...
        viewBox:"0 0 25 25",
        pathData:"M25 17.5V2.5C25 1.125 23.875 0 22.5 0H7.5C6.125 0 5 1.125 5 2.5V17.5C5 18.875 6.125 20 7.5 20H22.5C23.875 20 25 18.875 25 17.5ZM11.25 12.5L13.7875 15.8875L17.5 11.25L22.5 17.5H7.5L11.25 12.5ZM0 5V22.5C0 23.875 1.125 25 2.5 25H20V22.5H2.5V5H0Z",
        name:"Фотографии",
        badgeCount:6,
    },
      {
      ...
      },
      {
        ...
        viewBox:"0 0 25 25",
        pathData:"M12.5 25C19.4036 25 25 19.4036 25 12.5C25 5.59644 19.4036 0 12.5 0C5.59644 0 0 5.59644 0 12.5C0 19.4036 5.59644 25 12.5 25ZM6.00481 10.75L12.5 16L18.9952 10.75H6.00481Z",
        name:"Другое",
        badgeCount:10,
      },
  ...
  const userElems = [
    {
      userElemImg: "./img/profile/profile-img-1.jpeg", 
      mainText: "N E W", 
      secondaryText: "Развитие", 
      badgeCount: 3,
    },
    {
      userElemImg: "./img/profile/profile-img-2.jpeg", 
      mainText: "Aesthetics", 
      secondaryText: "Стиль", 
      badgeCount: 3,
    },
    {
      userElemImg: "./img/profile/profile-img-3.jpeg", 
      mainText: "дом твоей эстетики", 
      secondaryText: "Творчество", 
      badgeCount: 3,
    },
    {
      userElemImg: "./img/profile/profile-img-4.jpeg", 
      mainText: "wailet", 
      secondaryText: "Искусство", 
      badgeCount: 3,
    },
    {
      userElemImg: "./img/profile/profile-img-5.jpeg", 
      mainText: "A W E S O M E", 
      secondaryText: "Стиль", 
      badgeCount: 3,
    },
    {
      userElemImg: "./img/profile/profile-img-6.jpeg", 
      mainText: "minimalism", 
      secondaryText: "Фотография", 
      badgeCount: 3,
    },
    {
      userElemImg: "./img/profile/profile-img-7.jpeg", 
      mainText: "Словарный запас", 
      secondaryText: "Литература", 
      badgeCount: 3,
    },
    {
      userElemImg: "./img/profile/profile-img-8.jpeg", 
      mainText: "Look", 
      secondaryText: "Мода", 
      badgeCount: 3,
    },
  ...
  const postControls = [
    ...
    {
      iconWrap:"comment",
      whatCount: "comments-count",
      count: 500,
      className: "icon-comment",
      viewBox: "0 0 26 26",
      pathData: "M9.25 25.5C8.91848 25.5 8.60054 25.3683 8.36612 25.1339C8.1317 24.8995 8 24.5815 8 24.25V20.5H3C2.33696 20.5 1.70107 20.2366 1.23223 19.7678C0.763392 19.2989 0.5 18.663 0.5 18V3C0.5 2.33696 0.763392 1.70107 1.23223 1.23223C1.70107 0.763392 2.33696 0.5 3 0.5H23C23.663 0.5 24.2989 0.763392 24.7678 1.23223C25.2366 1.70107 25.5 2.33696 25.5 3V18C25.5 18.663 25.2366 19.2989 24.7678 19.7678C24.2989 20.2366 23.663 20.5 23 20.5H15.375L10.75 25.1375C10.5 25.375 10.1875 25.5 9.875 25.5H9.25ZM10.5 18V21.85L14.35 18H23V3H3V18H10.5Z",
      fill: "#6D6F7A"  
    },
    {
      iconWrap:"repost",
      ...
      <main className="Main">
        ...
        <div className="Post Repost _liked _marked">
          ...
          <div className="Repost__wrapper">
            ...
            <div className="media-container">
              <PostMediaItem
                imgPost="./img/post/garnet-man.png"
              />
              <PostMediaItem
                imgPost="./img/post/garnet.png"
              />
            </div>
          </div>
          <div className="PostControls">
